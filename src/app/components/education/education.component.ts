...
@Component({
  ...
  template: `
    <h1 class="text-center font-bold mb-16  text-blue-700">Education</h1>

    <div class="grid lg:grid-cols-2">
      <div class="grid-1 flex flex-col pl-5">
        <div class="my-8 relative" *ngFor="let item of schools; last as isLast">
          <app-education-item [data]="item"></app-education-item>
          <mat-divider *ngIf="!isLast"></mat-divider>
        </div>
      </div>
      <div class="grid-2 hidden lg:block ">
...
@Component({
  ...
  template: `
    <div class="relative w-auto">
      <div class="font-normal text-xl text-blue-700 mb-2">
        {{ data?.name }}
      </div>
